...
def predict_cases(model, list_of_lists, output_filenames, folds, arch, modality, save_npz, num_threads_preprocessing,
    ...
    trainer, params = load_model_and_checkpoint_files(model, folds, arch, modality, mixed_precision=mixed_precision,
...
def predict_from_folder(model: str, input_folder: str, output_folder: str, folds: Union[Tuple[int], List[int]], arch: str, modality: str,
    ...
    if mode == "normal":
        ...
        return predict_cases(model, list_of_lists[part_id::num_parts], output_files[part_id::num_parts], folds, arch, modality,
