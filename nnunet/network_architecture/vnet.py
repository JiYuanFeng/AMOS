...
from typing import Dict, Optional, Tuple, Type, Union,Sequence
...
class VNet(SegmentationNetwork):
    ...
    def forward(self, x):
        ...
        x4 = self.up_tr256(out256, out128) # [1, 256, 8, 20, 20]
        x3 = self.up_tr128(x4, out64)      # [1, 128, 16, 40, 40]
        x2 = self.up_tr64(x3, out32)       # [1, 64, 32, 80, 80]
        x1 = self.up_tr32(x2, out16)       # [1, 32, 64, 160, 160]
        out = self.out_tr(x1)
        return out
