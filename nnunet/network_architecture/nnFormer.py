...
class BasicLayer(nn.Module):
    ...
    def __init__(self,
        ...
        if downsample is not None:
            self.downsample = downsample(dim=dim, norm_layer=norm_layer,input_resolution=input_resolution )
        else:
...
class BasicLayer_up(nn.Module):
    ...
    def __init__(self,
        ...
        self.Upsample = upsample(dim=2 * dim, input_resolution=input_resolution, norm_layer=norm_layer)
