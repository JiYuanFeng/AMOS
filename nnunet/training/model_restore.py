...
def load_model_and_checkpoint_files(folder, folds=None, arch=None, modality=None, mixed_precision=None, checkpoint_name="model_best"):
    """
    ...
    if isinstance(folds, str):
        ...
        #     folds = [join(folder, "all")]
        if len(folds) == 1 and folds[0] == "preset":
            folds = [join(folder, "preset")]
        else:
